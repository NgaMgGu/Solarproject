...
lgmodel= st.sidebar.checkbox('Linear Regression')
kmmodel = st.sidebar.checkbox('Kmeans')
# Load the DataFrame from the provided data
...
if kmmodel:
    ...
    with st.sidebar.form("my_form1"):
        ...
        area = st.number_input('Shape_Area(sqm)')
        ghimW = st.number_input('GHI_MW')
        Cost = st.number_input('Cost_USD(M)')
